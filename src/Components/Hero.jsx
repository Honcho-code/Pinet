      ...
      <div className="wrapper mx-auto flex w-full max-w-2xl flex-1 flex-col sm:justify-center">
        <div className="flex flex-col items-center justify-center mt-36">
          ...
          <span className="text-2xl mt-4">
            Welcome to the <span className="font-bold">PiNet</span>
          </span>
        </div>
          ...
          <div>
            <div className="grid grid-cols-3 gap-3">
              <a
                ...
                href=""
              >
                <div className="w-16 h-16 flex justify-center items-center rounded-lg mb-2 ring-1 bg-white shadow-md ring-gray-600 group-focus-within:ring-purple-300 group-hover:outline-none group-hover:ring-purple-300 transition duration-150 overflow-hidden group-focus-within:ring-2">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="1024"
                    height="1024"
                    ...
                    fill="none"
                    className="w-full h-full text-purple-500 transition duration-150 group-hover:text-purple-400 group-focus:text-purple-400"
                  >
                    <path
                      fill="currentColor"
                ...
                <span className="group-focus-within:text-purple-300 group-hover:text-purple-300 transition duration-150">
                  Fireside
                </span>
              </a>
              <Link to="/wallet" className="group inline-flex flex-col justify-center items-center cursor-pointer pt-2 mb-2 rounded-lg focus:outline-none prevent-select" >
                <div className="w-16 h-16 flex justify-center items-center rounded-lg mb-2 ring-1 bg-white shadow-md ring-gray-600 group-focus-within:ring-purple-300 group-hover:outline-none group-hover:ring-purple-300 transition duration-150 overflow-hidden group-focus-within:ring-2">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="1024"
              ...
              <button className="group inline-flex flex-col justify-center items-center cursor-pointer pt-2 mb-2 rounded-lg focus:outline-none prevent-select">
                <div className="w-16 h-16 flex justify-center items-center rounded-lg mb-2 ring-1 bg-white shadow-md ring-gray-600 group-focus-within:ring-purple-300 group-hover:outline-none group-hover:ring-purple-300 transition duration-150 overflow-hidden group-focus-within:ring-2">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="1024"
              ...
              <button className="group inline-flex flex-col justify-center items-center cursor-pointer pt-2 mb-2 rounded-lg focus:outline-none prevent-select">
                <div className="w-16 h-16 flex justify-center items-center rounded-lg mb-2 ring-1 bg-white shadow-md ring-gray-600 group-focus-within:ring-purple-300 group-hover:outline-none group-hover:ring-purple-300 transition duration-150 overflow-hidden group-focus-within:ring-2">
                  ...
                  >
                    ...
                    <path
                      fill="#fff"
                      d="M247.641 275h528.696v320H247.641z"
                    ></path>
                    <path
                      fill="currentColor"
                      fillRule="evenodd"
              ...
              <button className="group inline-flex flex-col justify-center items-center cursor-pointer pt-2 mb-2 rounded-lg focus:outline-none prevent-select">
                <div className="w-16 h-16 flex justify-center items-center rounded-lg mb-2 ring-1 bg-white shadow-md ring-gray-600 group-focus-within:ring-purple-300 group-hover:outline-none group-hover:ring-purple-300 transition duration-150 overflow-hidden group-focus-within:ring-2">
                  ...
                  >
                    ...
                    <path
                      fill="currentColor"
                      d="M1046 1189h17l18 1 5 3 2 5 1 15v14l-5 3h-38l-5-3v-24l2-10 1-3z"
                    ></path>
                  </svg>
                </div>
                <span className="group-focus-within:text-purple-300 group-hover:text-purple-300 transition duration-150">
            ...
            <div className="flex justify-center mt-2">
              <a
                href=""
                target="_blank"
                className="text-lg text-purple-500 hover:text-purple-600 font-bold underline"
              >
                Privacy Policy
              </a>
            </div>
            <a
              className="inline-block rounded-lg text-center transition ease-in-out duration-300 focus-visible:outline-none focus-visible:outline-2 focus-visible:ring-inset focus-visible:outline-purple-500 disabled:bg-gray-500 text-white bg-purple-500 hover:bg-purple-700 px-4 py-2 w-full mt-4"
              href=""
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
